window.onload = function() {
	...
	allHeaderTags[0].style.color = '#dddddd';
	allHeaderTags[0].style.textShadow = '1px 1px 1px #555555';
	allHeaderTags[0].style.backgroundColor = 'transparent';
	...
	digitalClock.style.color = '#dddddd';
	digitalClock.style.textShadow = '1px 2px 2px #000000';
	...
	digitalClock.style.boxShadow = 'inset 0 0 15px 1px #555555, 0 0 4px 1px #555555';
